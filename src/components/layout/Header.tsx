...
export function Header() {
  ...
  return <header className="sticky top-0 z-50 backdrop-blur-xl bg-white/60 dark:bg-background/60 border-b border-black/[0.08] dark:border-white/[0.08] shadow-[0_4px_30px_rgba(0,0,0,0.05)] dark:shadow-[0_4px_30px_rgba(0,0,0,0.3)]">
