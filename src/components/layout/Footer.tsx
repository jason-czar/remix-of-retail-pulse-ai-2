  ...
  return <footer className="border-t border-border/50 py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Institutional-grade retail sentiment intelligence powered by StockTwits data.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/alerts" className="text-muted-foreground hover:text-foreground transition-colors">
                  Alerts
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-border/50 pt-8 text-center text-sm text-muted-foreground">
          © {new Date().getFullYear()} Derive Street. All rights reserved.
        </div>
      </div>
    </footer>;
}