    ...
    <section className="relative py-20 lg:py-32">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div 
            className="relative glass-card p-8 md:p-12 lg:p-16 text-center"
          ...
          >
            ...
            <motion.h1 
              className="text-3xl md:text-4xl lg:text-5xl font-display font-semibold leading-tight mb-6"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.2, ease: [0.25, 0.4, 0.25, 1] }}
            >
              We read the retail investor market, <span className="text-gradient">so you can stay ahead of it.</span>
            </motion.h1>
