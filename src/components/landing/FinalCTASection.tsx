            ...
            <div className="glass-card p-8 md:p-12 text-center relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <div className="flex flex-row gap-3 sm:gap-4 justify-center">
                  <Link to="/symbol/NVDA">
                    <Button size="lg" className="px-6 sm:px-8 rounded-full glass-button-primary group">
                      View NVDA
                      <ArrowRight className="ml-2 h-4 w-4 group-hover:translate-x-1 transition-transform" />
                    </Button>
                  </Link>
                  <Link to="/signup">
                    <Button variant="ghost" size="lg" className="px-6 sm:px-8 rounded-full glass-button-secondary">
                      Get Started
                    </Button>
                  </Link>
                </div>
