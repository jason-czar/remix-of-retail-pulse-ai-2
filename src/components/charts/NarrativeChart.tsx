            ...
            <div className="flex-1 min-w-0 pl-[27px] pr-[10px]">
              <ResponsiveContainer width="100%" height="100%">
                ...
                bottom: 10
                  ...
                  <defs>
                    {/* Solid fill above previous close - consistent 0.4 opacity, clipped at baseline */}
                    <linearGradient id="priceAboveGradient" x1="0" y1="0" x2="0" y2="1">
                      {priceGradientStops ? (
                        <>
                          <stop offset="0%" stopColor={PRICE_UP_COLOR} stopOpacity={0.4} />
                          <stop offset={`${priceGradientStops.previousClosePercent}%`} stopColor={PRICE_UP_COLOR} stopOpacity={0.4} />
                    ...
                    {/* Solid fill below previous close - consistent 0.4 opacity, clipped at baseline */}
                    <linearGradient id="priceBelowGradient" x1="0" y1="0" x2="0" y2="1">
                      {priceGradientStops ? (
                        <>
                          <stop offset="0%" stopColor="transparent" stopOpacity={0} />
                          <stop offset={`${priceGradientStops.previousClosePercent}%`} stopColor="transparent" stopOpacity={0} />
                          <stop offset={`${priceGradientStops.previousClosePercent}%`} stopColor={PRICE_DOWN_COLOR} stopOpacity={0.4} />
                          <stop offset="100%" stopColor={PRICE_DOWN_COLOR} stopOpacity={0.4} />
                        </>
                      ) : (
                        <stop offset="0%" stopColor={PRICE_DOWN_COLOR} stopOpacity={0.4} />
                      )}
                    </linearGradient>
                    ...
                    {firstPriceData && (
                      <linearGradient id="priceExtensionFillGradient" x1="0" y1="0" x2="0" y2="1">
                        <stop offset="0%" stopColor={firstPriceData.color} stopOpacity={0.4} />
                        <stop offset="100%" stopColor={firstPriceData.color} stopOpacity={0.4} />
                      </linearGradient>
                    )}
                  </defs>
