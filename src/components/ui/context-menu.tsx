...
>(({ className, ...props }, ref) => (
  <ContextMenuPrimitive.SubContent
    ...
    className={cn(
      ...
      "bg-[hsl(var(--popover))] border border-border backdrop-blur-xl",
      "dark:border-white/10 dark:shadow-[0_8px_32px_hsl(240_15%_0%/0.3),inset_0_1px_0_hsl(0_0%_100%/0.05)]",
      "shadow-[0_8px_32px_hsl(206_100%_50%/0.08),inset_0_1px_0_hsl(0_0%_100%/0.5)]",
      className,
    )}
    {...props}
  />
