...
const Sidebar = React.forwardRef<HTMLDivElement, React.ComponentProps<"div"> & {
  ...
  if (isMobile) {
    return <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent data-sidebar="sidebar" data-mobile="true" className="w-[--sidebar-width] bg-white/90 dark:bg-[hsl(0_0%_10%/0.95)] backdrop-blur-xl p-0 text-sidebar-foreground [&>button]:hidden border-r border-white/[0.08]" style={{
      ...
      <div className={cn(
        ...
        <div 
          ...
          className={cn(
            ...
            // Simplified shadow matching Messages Sidebar
            "shadow-[0_8px_32px_rgba(0,0,0,0.08),0_2px_8px_rgba(0,0,0,0.04)]",
            "dark:shadow-[0_8px_32px_rgba(0,0,0,0.4),0_2px_8px_rgba(0,0,0,0.2)]",
            // Subtle top highlight line
            "before:absolute before:inset-x-0 before:top-0 before:h-[1px] before:bg-gradient-to-r before:from-transparent before:via-white/40 before:to-transparent before:pointer-events-none before:z-10",
