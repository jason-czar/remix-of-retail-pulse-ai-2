...
>(({ className, ...props }, ref) => (
  <div 
    className="flex items-center border-b border-black/[0.06] dark:border-white/10 px-4 py-1 glass-input !border-t-0 !border-l-0 !border-r-0 !rounded-none !rounded-t-2xl" 
    cmdk-input-wrapper=""
  >
