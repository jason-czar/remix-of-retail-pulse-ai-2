...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ...
    className={cn(
      ...
      "bg-muted/60 dark:bg-[linear-gradient(135deg,hsl(240_15%_20%/0.4)_0%,hsl(240_15%_10%/0.2)_100%)]",
      "backdrop-blur-xl",
      "border border-border/40 dark:border-white/10",
      "shadow-sm dark:shadow-[0_8px_32px_hsl(240_15%_0%/0.4),0_2px_8px_hsl(240_20%_10%/0.2),inset_0_1px_0_hsl(0_0%_100%/0.08)]",
      className,
    )}
    {...props}
  />
