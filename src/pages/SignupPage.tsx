...
const glassCardClasses = cn("p-8 rounded-2xl", "bg-white/60 dark:bg-[hsl(0_0%_12%/0.55)]", "backdrop-blur-[28px] backdrop-saturate-[140%]", "border border-black/[0.08] dark:border-white/[0.06]", "shadow-[0_8px_32px_rgba(0,0,0,0.04),0_2px_8px_rgba(0,0,0,0.02)]");
...
const glassBenefitClasses = cn("p-1 rounded-full", "bg-primary/10 dark:bg-primary/20");
        ...
        <div className="w-full max-w-4xl grid md:grid-cols-2 gap-8 relative">
          ...
          <div className="hidden md:flex flex-col justify-center">
            ...
            <ul className="space-y-4">
              {["Real-time sentiment analytics for 8,500+ symbols", "AI-powered narrative and emotion extraction", "Custom alerts for sentiment shifts", "Developer API with generous free tier", "No credit card required"].map(benefit => <li key={benefit} className="flex items-start gap-3">
          ...
          <div className={glassCardClasses}>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="fullName" type="text" placeholder="John Doe" value={fullName} onChange={e => setFullName(e.target.value)} className={glassInputClasses} required />
              </div>
